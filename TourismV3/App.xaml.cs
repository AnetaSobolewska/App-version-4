...
namespace TourismV3
{
    ...
    sealed partial class App : Application
    {
        ...
        // ADDED BY DAN - defining database path property
        ...
        protected override async void OnLaunched(LaunchActivatedEventArgs e)
        {
            ...
            // ADDED BY DAN - creating the database path.
            DBPath = Path.Combine(Windows.Storage.ApplicationData.Current.LocalFolder.Path, "RestaurantDatabase.sqlite");
